...
dabtram_lineages <- dabtram_lineages[!(row.names(dabtram_lineages) %in% c("Still multiple","No Barcode"))]

#Keep lineages with more than 5 cells:
dabtram_lineages_thresholded <- dabtram_lineages[dabtram_lineages>=number_of_cells_threshold]
...
#Remove still multiple and no barcode:
dabtramtodabtram_lineages <- dabtramtodabtram_lineages[!(row.names(dabtramtodabtram_lineages) %in% c("Still multiple","No Barcode"))]

#Keep lineages with 5 or more cells:
dabtramtodabtram_lineages_thresholded <- dabtramtodabtram_lineages[dabtramtodabtram_lineages>=number_of_cells_threshold]




dabtram_and_dabtramtodabtram_lineages <- Reduce(intersect,list(names(dabtram_lineages_thresholded)
,names(dabtramtodabtram_lineages_thresholded)
))
