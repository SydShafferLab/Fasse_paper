...
heatmap(log(first_sorted[rowSums(first_sorted, na.rm = TRUE) > 0,]+1), scale = "none", Colv = NA, Rowv = NA, col= brewer.pal(n = 9, name = 'Greys'),
        ylab = paste0('n=', 0.25*(length(first_sorted[rowSums(first_sorted, na.rm = TRUE) > 0]))))
dev.off()
...
heatmap(log(dabtram_sorted[rowSums(dabtram_sorted, na.rm = TRUE) > 0,]+1), scale = "none", Colv = NA, Rowv = NA, col= brewer.pal(n = 9, name = 'Greys'), 
        ylab = paste0('n=', 0.25*(length(dabtram_sorted[rowSums(dabtram_sorted, na.rm = TRUE) > 0]))))
dev.off()
...
heatmap(log(cocl2_sorted[rowSums(cocl2_sorted, na.rm = TRUE) > 0,]+1), scale = "none", Colv = NA, Rowv = NA, col= brewer.pal(n = 9, name = 'Greys'), 
        ylab = paste0('n=', 0.25*(length(cocl2_sorted[rowSums(cocl2_sorted, na.rm = TRUE) > 0]))))
dev.off()
...
heatmap(log(cis_sorted[rowSums(cis_sorted, na.rm = TRUE) > 0,]+1), scale = "none", Colv = NA, Rowv = NA, col= brewer.pal(n = 9, name = 'Greys'), 
        ylab = paste0('n=', 0.25*(length(cis_sorted[rowSums(cis_sorted, na.rm = TRUE) > 0]))))
dev.off()
