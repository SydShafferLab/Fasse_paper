...
```{r}
gDNA_anno <- list()
names(gDNA_files)[names(gDNA_files) == 'sc_output_counts_AJF009_FirstSample1_gDNA_S13.txt'] <- 'sc_output_counts_AJF009_FirstSample_1_gDNA_S13.txt'
...
# now have the condition appended
