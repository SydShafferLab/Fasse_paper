...
pearson_ttest_cocl2_firstvsrand <- t.test(cocl2_first_pearson_filt, cocl2_first_pearson_filt_rand, alternative = 'greater', paired = F)
pearson_ttest_cocl2_secondvsrand <- t.test(cocl2_second_pearson_filt, cocl2_second_pearson_filt_rand, alternative = 'greater', paired = F)
pearson_ttest_cocl2_secondvsfirst <- t.test(cocl2_second_pearson_filt, cocl2_first_pearson_filt, alternative = 'greater', paired = F)
...
# Save outputs
save(pearson_ttest_cocl2_firstvsrand, pearson_ttest_cocl2_secondvsfirst, pearson_ttest_cocl2_secondvsrand, file = '2022_01_14_analysis_scripts/2022_05_27_analysis/Condition_Clustering/cocl2_pearson_values.RData')
rm(pearson_ttest_cocl2_firstvsrand, pearson_ttest_cocl2_secondvsfirst, pearson_ttest_cocl2_secondvsrand)
...
pearson_ttest_dabtram_firstvsrand <- t.test(dabtram_first_pearson_filt, dabtram_first_pearson_filt_rand, alternative = 'greater', paired = F)
pearson_ttest_dabtram_secondvsrand <- t.test(dabtram_second_pearson_filt, dabtram_second_pearson_filt_rand, alternative = 'greater', paired = F)
pearson_ttest_dabtram_secondvsfirst <- t.test(dabtram_second_pearson_filt, dabtram_first_pearson_filt, alternative = 'greater', paired = F)
...
# Save outputs
save(pearson_ttest_dabtram_firstvsrand, pearson_ttest_dabtram_secondvsfirst, pearson_ttest_dabtram_secondvsrand, file = '2022_01_14_analysis_scripts/2022_05_27_analysis/Condition_Clustering/dabtram_pearson_values.RData')
rm(pearson_ttest_dabtram_firstvsrand, pearson_ttest_dabtram_secondvsfirst, pearson_ttest_dabtram_secondvsrand)
...
pearson_ttest_cis_firstvsrand <- t.test(cis_first_pearson_filt, cis_first_pearson_filt_rand, alternative = 'greater', paired = F)
pearson_ttest_cis_secondvsrand <- t.test(cis_second_pearson_filt, cis_second_pearson_filt_rand, alternative = 'greater', paired = F)
pearson_ttest_cis_secondvsfirst <- t.test(cis_second_pearson_filt, cis_first_pearson_filt, alternative = 'greater', paired = F)
...
# Save outputs
save(pearson_ttest_cis_firstvsrand, pearson_ttest_cis_secondvsfirst, pearson_ttest_cis_secondvsrand, file = '2022_01_14_analysis_scripts/2022_05_27_analysis/Condition_Clustering/cis_pearson_values.RData')
rm(pearson_ttest_cis_firstvsrand, pearson_ttest_cis_secondvsfirst, pearson_ttest_cis_secondvsrand)
...
comparisons <-  c('dabtram_firstvsrand', 'dabtram_secondvsrand', 'dabtram_secondvsfirst','cocl2_firstvsrand', 'cocl2_secondvsrand', 'cocl2_secondvsfirst', 'cis_firstvsrand', 'cis_secondvsrand', 'cis_secondvsfirst')

t_statistic <- c(pearson_ttest_dabtram_firstvsrand$statistic, pearson_ttest_dabtram_secondvsrand$statistic, pearson_ttest_dabtram_secondvsfirst$statistic, pearson_ttest_cocl2_firstvsrand$statistic, pearson_ttest_cocl2_secondvsrand$statistic, pearson_ttest_cocl2_secondvsfirst$statistic, pearson_ttest_cis_firstvsrand$statistic, pearson_ttest_cis_secondvsrand$statistic, pearson_ttest_cis_secondvsfirst$statistic)

t_pval <- c(pearson_ttest_dabtram_firstvsrand$p.value, pearson_ttest_dabtram_secondvsrand$p.value, pearson_ttest_dabtram_secondvsfirst$p.value, pearson_ttest_cocl2_firstvsrand$p.value, pearson_ttest_cocl2_secondvsrand$p.value, pearson_ttest_cocl2_secondvsfirst$p.value, pearson_ttest_cis_firstvsrand$p.value, pearson_ttest_cis_secondvsrand$p.value, pearson_ttest_cis_secondvsfirst$p.value)
...
# Look at whether the differences in CoCl2 clustering are caused by one massive lineage ##### CAN BE REMOVED
```{r}

# Need to load the second-timepoint object in and assign lineages
load('2022_01_14_analysis_scripts/2022_05_27_analysis/Preprocess_GEX/second_timepoint_merged.RData')
load('2022_01_14_analysis_scripts/2022_05_27_analysis/Assign_dominant_barcodes/all_data_final_lineages.RData')
second_timepoint$Lineage <- all_data$Lineage[names(all_data$orig.ident) %in% names(second_timepoint$orig.ident)]

#Find lineage sizes cocl2tococl2
cocl2tococl2_lin_sizes <- table(second_timepoint$Lineage[second_timepoint$OG_condition == 'cocl2tococl2'])
cocl2tococl2_largest_lin <- names(which.max(cocl2tococl2_lin_sizes))

DimPlot(second_timepoint, cells.highlight = names(second_timepoint$orig.ident)[second_timepoint$Lineage == cocl2tococl2_largest_lin & second_timepoint$OG_condition == 'cocl2tococl2'], cols.highlight = 'darkred')
DimPlot(second_timepoint, cells.highlight = names(second_timepoint$orig.ident)[second_timepoint$Lineage != cocl2tococl2_largest_lin & second_timepoint$OG_condition == 'cocl2tococl2'], cols.highlight = 'darkblue')

DimPlot(second_timepoint, cells.highlight= list(names(second_timepoint$orig.ident)[second_timepoint$Lineage == cocl2tococl2_largest_lin & second_timepoint$OG_condition == 'cocl2tococl2'], names(second_timepoint$orig.ident)[second_timepoint$Lineage != cocl2tococl2_largest_lin & second_timepoint$OG_condition == 'cocl2tococl2']), cols.highlight = c("darkblue", "darkred"), cols= "grey")

#Find lineage sizes dabtramtococl2
dabtramtococl2_lin_sizes <- table(second_timepoint$Lineage[second_timepoint$OG_condition == 'dabtramtococl2'])
dabtramtococl2_largest_lin <- names(which.max(dabtramtococl2_lin_sizes[names(dabtramtococl2_lin_sizes) != c('No Barcode') & names(dabtramtococl2_lin_sizes) != c('Still multiple')]))

DimPlot(second_timepoint, cells.highlight = names(second_timepoint$orig.ident)[second_timepoint$Lineage == dabtramtococl2_largest_lin & second_timepoint$OG_condition == 'dabtramtococl2'], cols.highlight = 'darkred')
DimPlot(second_timepoint, cells.highlight = names(second_timepoint$orig.ident)[second_timepoint$Lineage != dabtramtococl2_largest_lin & second_timepoint$OG_condition == 'dabtramtococl2'], cols.highlight = 'darkblue')

DimPlot(second_timepoint, cells.highlight= list(names(second_timepoint$orig.ident)[second_timepoint$Lineage == dabtramtococl2_largest_lin & second_timepoint$OG_condition == 'dabtramtococl2'], names(second_timepoint$orig.ident)[second_timepoint$Lineage != dabtramtococl2_largest_lin & second_timepoint$OG_condition == 'dabtramtococl2']), cols.highlight = c("darkblue", "darkred"), cols= "grey")

#Find lineage sizes cistococl2
cistococl2_lin_sizes <- table(second_timepoint$Lineage[second_timepoint$OG_condition == 'cistococl2'])
cistococl2_largest_lin <- names(which.max(cistococl2_lin_sizes[names(cistococl2_lin_sizes) != c('No Barcode') & names(cistococl2_lin_sizes) != c('Still multiple')]))

DimPlot(second_timepoint, cells.highlight = names(second_timepoint$orig.ident)[second_timepoint$Lineage == cistococl2_largest_lin & second_timepoint$OG_condition == 'cistococl2'], cols.highlight = 'darkred')
DimPlot(second_timepoint, cells.highlight = names(second_timepoint$orig.ident)[second_timepoint$Lineage != cistococl2_largest_lin & second_timepoint$OG_condition == 'cistococl2'], cols.highlight = 'darkblue')

DimPlot(second_timepoint, cells.highlight= list(names(second_timepoint$orig.ident)[second_timepoint$Lineage == cistococl2_largest_lin & second_timepoint$OG_condition == 'cistococl2'], names(second_timepoint$orig.ident)[second_timepoint$Lineage != cistococl2_largest_lin & second_timepoint$OG_condition == 'cistococl2']), cols.highlight = c("darkblue", "darkred"), cols= "grey")
```
