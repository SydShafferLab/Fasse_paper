...
# This chunk works with different clusters in the all_data object but for actual plotting I will look at the second_timepoint object
<!-- # Get 13 cluster UMAP to look at cluster assignment in large number of clusters -->
<!-- ```{r} -->
