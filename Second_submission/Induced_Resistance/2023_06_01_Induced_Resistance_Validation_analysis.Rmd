...
for(i in unique(area_df$seeding_num)) {
  if(i == '1000'){
    ...
    p <- filter_all(pvals_df, any_vars(.==i))
    print(ggplot(t) +
            geom_violin(aes(x= il6st, y= area, fill = il6st)) +
...
ggplot(area_df) +
  geom_violin(aes(x = interaction(il6st, seeding_num), y = area, fill = il6st)) +
  geom_point(aes(x = interaction(il6st, seeding_num), y = area), color = 'black') +
