...
#dir.create('2023_10_12_analysis/cellarea_count2')
```

## Import cell area csvs
```{r}
setwd('2023_10_12_analysis/cellarea_outputs2')
...
#dir.create('2023_10_12_analysis/cellarea_count2/rdata2')
save(area_df, file='2023_10_12_analysis/cellarea_count2/rdata2/areas_exp.RData')
...
save(area_ctrl_df, file='2023_10_12_analysis/cellarea_count2/rdata2/areas_ctrl.RData')

```

## reload
```{r}
load('2023_10_12_analysis/cellarea_count2/rdata2/areas_exp.RData')
load('2023_10_12_analysis/cellarea_count2/rdata2/areas_ctrl.RData')

```

## Raw area plots
```{r}
#dir.create('2023_10_12_analysis/cellarea_count2/plots2')

# Raw counts
pdf(file="2023_10_12_analysis/cellarea_count2/plots2/raw_plots.pdf")
seeding_nums <- list()
...
scaling_factor_alllow <- area_ctrl_df[4,5]/area_ctrl_df[4,5]
scaling_factor_lowplate5 <- area_ctrl_df[7,5]/area_ctrl_df[4,5]
scaling_factor_allhigh <- area_ctrl_df[1,5]/area_ctrl_df[4,5]
...
load('2023_10_12_analysis/cellarea_count2/rdata2/areas_exp.RData')
load('2023_10_12_analysis/cellarea_count2/rdata2/areas_ctrl.RData')
load('023_10_12_analysis/cellarea_count2/rdata2/pvals.RData')
...
# Norm counts
pdf(file="2023_10_12_analysis/cellarea_count2/plots2/norm_plots.pdf")
...
# Log2 FC
pdf(file="2023_10_12_analysis/cellarea_count2/plots2/log2_plots.pdf")
for(i in unique(area_df$seeding_num)) {
  t <- filter_all(area_df, any_vars(.==i))
  t$il6st <- factor(t$il6st, levels = c("Low", "High"))
  print(ggplot(t) +
...
save(pvals_df, file='2023_10_12_analysis/cellarea_count2/rdata2/pvals.RData')
...
# Log2 FC w pval
pdf(file="2023_10_12_analysis/cellarea_count2/plots2/log2_pval_norm_plots.pdf")
for(i in unique(area_df$seeding_num)) {
  t <- filter_all(area_df, any_vars(.==i))
  t$il6st <- factor(t$il6st, levels = c("Low", "High"))
...
# Log2 FC w pval
pdf(file="2023_10_12_analysis/cellarea_count2/plots2/log2_pval_norm_1000.pdf")
for(i in unique(area_df$seeding_num)) {
  if(i == '1000'){
    t <- filter_all(area_df, any_vars(.==i))
    t$il6st <- factor(t$il6st, levels = c("Low", "High"))
...
pdf(file="2023_10_12_analysis/cellarea_count2/plots2/log2_pval_norm.pdf")
