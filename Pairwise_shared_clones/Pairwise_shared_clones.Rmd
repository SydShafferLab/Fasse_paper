...
###########DimPlot(cis, cells.highlight = list(colnames(cis)[cis$Lineage %in% cis_venn_data$`cistococl2:cistodabtram`],colnames(cis)[cis$Lineage %in% cis_venn_data$`cistocis:cistococl2`],colnames(cis)[cis$Lineage %in% cis_venn_data$`cistocis:cistococl2:cistodabtram`]), cols.highlight = c('red','blue','green'))
...
#### WORKING
DimPlot(cocl2, cells.highlight = list(colnames(cocl2)[cocl2$Lineage %in% cocl2_venn_data$`cocl2tococl2:cocl2todabtram`],colnames(cocl2)[cocl2$Lineage %in% cocl2_venn_data$`cocl2tocis:cocl2todabtram`],colnames(cocl2)[cocl2$Lineage %in% cocl2_venn_data$`cocl2tocis:cocl2tococl2`],colnames(cocl2)[cocl2$Lineage %in% cocl2_venn_data$`cocl2tocis:cocl2tococl2:cocl2todabtram`]), cols.highlight = c('red','blue','green','orange'))
...
###DimPlot(dabtram, cells.highlight = list(colnames(dabtram)[dabtram$Lineage %in% dabtram_venn_data$`dabtramtococl2:dabtramtodabtram`],colnames(dabtram)[dabtram$Lineage %in% dabtram_venn_data$`dabtramtocis:dabtramtococl2`],colnames(dabtram)[dabtram$Lineage %in% dabtram_venn_data$`dabtramtocis:dabtramtococl2:dabtramtodabtram`]), cols.highlight = c('red','blue','green'))
