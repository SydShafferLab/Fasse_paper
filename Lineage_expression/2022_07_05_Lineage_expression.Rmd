...
```
# Look at similarity within lineages based on clustering
...
## Build dataframe of overall clustering simulation results
```{r}
sim_results <- rbind(
...
## Load clustering simulation data back in
```{r}
...
## Plot heatmaps of true percentage of cells per lineage in each cluster vs random clustering simulations
```{r}
