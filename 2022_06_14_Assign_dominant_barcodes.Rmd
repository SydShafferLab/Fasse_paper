...
dir <- '/Volumes/GoogleDrive/My Drive/Fasse_Shared/AJF_Drive_copy/Experiments/AJF009/'

load(paste0(dir, '2022_01_14_analysis_scripts/2022_05_27_analysis/Preprocess_GEX/all_data_merged.RData')) #for merged object
load(paste0(dir, '2022_01_14_analysis_scripts/2022_05_27_analysis/Preprocess_GEX/Objects_premerged.RData')) #for individual objects
load('/Volumes/GoogleDrive/My Drive/Fasse_Shared/AJF_Drive_copy/Experiments/AJF009/2022_01_14_analysis_scripts/2022_05_27_analysis/Preprocess_GEX/dabtram_both_times.RData')

reference <- read.delim(paste0(dir, '2022_05_19_Barcode_outputs/CellRanger_inputs/FeatureReference_filtered.csv'))

load(paste0(dir, '2022_01_14_analysis_scripts/2022_05_27_analysis/Test_barcode_assignment/lineage_count_cutoffs.RData')) #lineage count cutoffs from test_barcode_assignment
...
save(dabtram_both_times, file = 'dabtram_both_times_final_lineages.RData')
...
save(dabtram, file = "dabtram_final_lineages.RData")
...
save(cocl2, file = "cocl2_final_lineages.RData")
...
save(cis, file = "cis_final_lineages.RData")

#dabtram both times can we just add back into the dabtram
...
```{r}
#dabtram first, minus other things that have dabtram in name
load('/Volumes/GoogleDrive/My Drive/Fasse_Shared/AJF_Drive_copy/Experiments/AJF009/2022_01_14_analysis_scripts/2022_01_31_analysis_scripts/Preprocess_GEX/dabtram_first_merged.RData')
...
dabtram_first_inds <- dabtram_inds[dabtram_inds %nin% c(cocl2todabtram_inds, cistodabtram_inds)]
...
dabtram_first$Lineage <- all_data$Lineage[dabtram_first_inds]
save(dabtram_first, file = 'dabtram_first_final_lineages.RData')

dabtram$Lineage <- all_data$Lineage[dabtram_inds]
save(dabtram, file = "dabtram_final_lineages.RData")
