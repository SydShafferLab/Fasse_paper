...
for (i in rownames(dabtram_inducedto_cocl2_markers_sig_p)){
  print(FeaturePlot(dabtram, features = c(i)) & scale_colour_gradientn(colors = rev(brewer.pal(n = 11, name = 'RdBu'))) &  DarkTheme())
...
for (i in rownames(cocl2_inducedto_dabtram_markers_sig_p)){
  print(FeaturePlot(cocl2, features = c(i)) & scale_colour_gradientn(colors = rev(brewer.pal(n = 11, name = 'RdBu'))) &  DarkTheme())
...
for (i in rownames(cis_inducedto_dabtram_markers_sig_p)){
  print(FeaturePlot(cis, features = c(i)) & scale_colour_gradientn(colors = rev(brewer.pal(n = 11, name = 'RdBu'))) &  DarkTheme())
